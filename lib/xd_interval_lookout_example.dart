...
class XDIntervalLookoutExample extends StatelessWidget {
  XDIntervalLookoutExample({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(
            ...
            margin: EdgeInsets.fromLTRB(161.0, 257.0, 160.0, 290.0),
          ),
          Container(),
          Pinned.fromPins(
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          width: 3.0, color: const Color(0xffebebeb)),
                    ),
                  ),
                  Transform.translate(
                    offset: Offset(25.0, 26.0),
                    child: Text(
                      'Thanksgiving Party',
                      style: TextStyle(
                        fontFamily: 'Poppins',
          ...
          Container(
            ...
            margin: EdgeInsets.fromLTRB(181.0, 967.0, 179.0, 303.0),
          ),
          Pinned.fromPins(
            Pin(size: 1.0, end: 192.5),
            Pin(size: 112.0, middle: 0.6135),
...
const String _svg_hvrxt =
    '<svg viewBox="846.5 986.5 1.0 112.0" ><path transform="translate(846.5, 986.5)" d="M 1 0 L 0 112" fill="none" stroke="#ffffff" stroke-width="10" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
