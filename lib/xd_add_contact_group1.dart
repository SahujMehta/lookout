...
class XDAddContactGroup1 extends StatelessWidget {
  XDAddContactGroup1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Transform.translate(
            offset: Offset(195.0, 794.0),
            child: Text(
              'Inform Contact of Status:',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 40,
                color: const Color(0xff2bd4c1),
          ...
          Align(
            alignment: Alignment(0.052, 0.403),
            child: SizedBox(
              width: 694.0,
              height: 340.0,
              child: Stack(
...
const String _svg_dw4cg6 =
    '<svg viewBox="2.8 2.8 53.9 54.7" ><path transform="translate(2.77, 2.77)" d="M 53.94062042236328 31.26424407958984 L 30.82321166992188 31.26424407958984 L 30.82321166992188 54.71242904663086 L 23.11740875244141 54.71242904663086 L 23.11740875244141 31.26424407958984 L 0 31.26424407958984 L 0 23.44818305969238 L 23.11740875244141 23.44818305969238 L 23.11740875244141 0 L 30.82321166992188 0 L 30.82321166992188 23.44818305969238 L 53.94062042236328 23.44818305969238 L 53.94062042236328 31.26424407958984 Z" fill="#2bd4c1" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
